...
parser.add_argument('--config_env',default='/root/Myproject/scan/configs/env.yml',
                    help='Config file for the environment')
parser.add_argument('--config_exp',default='/root/Myproject/scan/configs/selflabel/selflabel_cifar10.yml',
