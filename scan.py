...
def main():
    ...
    #tensorboard
    writer = SummaryWriter('/root/DeepClustermyproject/run_tensorboard_cifar10')
    ...
    for epoch in range(start_epoch, p['epochs']):
        ...
        data_write_csv("/root/DeepClustermyproject/different_dataset/cluster_cifar10.csv", cluster_data)
